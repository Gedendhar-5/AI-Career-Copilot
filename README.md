...
│   Profile | Analyzer | Chat | Roadmap | Tasks | Dashboard│
└──────┬──────────┬──────────────┬───────────────┬────────┘
       │          │              │               │
┌──────▼──┐  ┌────▼─────┐  ┌───▼────┐  ┌───────▼──────┐
│  MEMORY │  │   RAG    │  │ AGENTS │  │  LLM ENGINE  │
│  LAYER  │  │ PIPELINE │  │ LAYER  │  │   (Groq)     │
│         │  │          │  │        │  │              │
│users.json│  │  FAISS  │  │Planner │  │Llama 3.3 70B│
│plans.json│  │Retriever│  │Advisor │  │              │
│tasks.json│  │  Parser │  │TaskGen │  │Prompt Builder│
└─────────┘  └──────────┘  └────────┘  └──────────────┘
       │          │              │               │
       └──────────┴──────────────┴───────────────┘
                         │
